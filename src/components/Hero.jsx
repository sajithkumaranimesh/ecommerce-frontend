...
export default function Hero() {
    return (
      <section
        ...
        style={{
          backgroundImage:
            "url('https://tilmalanka.com/wp-content/uploads/2023/05/istockphoto-537173449-612x612-1.jpg')",
        }}
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center text-white px-4 md:px-8">
          ...
          <p className="text-lg sm:text-xl md:text-2xl mb-6">
            Handpicked and ethically sourced, our Ceylon cinnamon is packed with
            rich aroma, delicate sweetness, and incredible health benefits.
            Elevate your lifestyle with the finest spice from Sri Lanka.
          </p>
          <a href="#services">
